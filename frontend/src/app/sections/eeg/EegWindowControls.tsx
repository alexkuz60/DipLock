 ...
 * состояние у раздела своё: уровень зума в `eegParams` (расчёт от него не
 * устаревает), команда листания — через `eegNav` с монотонным `seq`, потому что
 * окно раздела живёт в состоянии, а не в компоненте: его видят обе половины.
 */
