...
## 17.09.2026 — страховка перед рефакторингом: CI + ruff/mypy и первый срез разрезки UI
...
- **Тесты:** 327 pytest, 564 Vitest (51 файл; было 559 в 49 — новые модули разрезки получили свои тесты).
