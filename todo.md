...
- [x] **Фаза 2, срез 2.6 (13.09.2026):** слои результата на фикстурах — зоны артефактов,
      ...
      Vitest, 95 pytest
- [ ] **Фаза 2, срез 2.7:** подключение стадий: `POST /recordings/{id}/preprocess`
      (stage=filter/artifacts/epochs) с прогрессом по этапам — кнопки шапки становятся активными,
      результат синхронизируется с треками
