...
- [ ] **Фаза 2, срез 2.2:** загрузка записи (DnD + прогресс) → `POST /recordings`, карточка метаданных
- [ ] **Фаза 2, срез 2.3:** вьюер треков на фикстурах (uPlot, ось времени, курсор, мкВ, mute/solo,
      зум ×1…×16 с min/max-огибающей)
