...
| `docs/rules/tests.md` | покрытие (654 Vitest / 386 pytest), ruff/mypy и CI |
...
| `audit.md`, `audit-2026-09.md`, `audit_strategy.md` | долг и находки: F17–F21, A1–A11, P1–P9 (§7 — производительность клиента); `audit_strategy.md` — вердикты по направлениям (N1–N40) |
